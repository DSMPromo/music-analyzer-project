/**
 * @module LoudnessTimeline
 * @description React component for visualizing loudness over time
 *
 * Displays a LUFS heatmap bar chart synchronized with the spectrogram.
 * Color-coded bars indicate loudness levels (good/warm/hot) and
 * supports click-to-seek and hover tooltips.
 *
 ...
 *
 * LUFS heatmap bar chart synced with spectrogram playhead.
 * Shows integrated LUFS, peak, and dynamic range statistics.
 *
 * @component
 * @param {Object} props - Component props
 * @param {Object} props.loudnessData - Loudness analysis from useMixAnalysis
 ...
 * @param {function} [props.onSeek] - Callback when clicking to seek
 * @param {number} [props.height=60] - Component height in pixels
 * @param {boolean} [props.showLabels=true] - Show LUFS axis labels
 * @returns {JSX.Element} Loudness timeline component
 *
 * @example
 * <LoudnessTimeline
 *   loudnessData={analysisResults?.loudness}
