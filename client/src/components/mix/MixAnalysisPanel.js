/**
 * @module MixAnalysisPanel
 * @description React component for displaying mix analysis results
 *
 * Displays detected mix issues organized by severity with interactive
 * controls to jump to problem areas or solo specific frequencies.
 *
 ...
 * Groups issues by severity (severe, moderate, mild) and shows
 * an overall status indicator.
 *
 * @component
 * @param {Object} props - Component props
 * @param {Object} props.analysisResults - Results from useMixAnalysis hook
 * @param {boolean} props.isAnalyzing - True while analysis is running
 * @param {number} props.progress - Analysis progress (0-1)
 * @param {function} [props.onSeek] - Callback to seek to time position
 * @param {function} [props.onSoloFrequency] - Callback to solo a frequency
 * @param {boolean} [props.collapsed=false] - Whether panel is collapsed
 * @param {function} [props.onToggleCollapse] - Callback to toggle collapse
 * @returns {JSX.Element} Mix analysis panel
 *
 * @example
 * <MixAnalysisPanel
 ...
 *   onSoloFrequency={(freq) => soloFrequency(freq)}
 * />
 */
 ...
 *
 * Renders a single mix issue with its details and action buttons.
 *
 * @component
 * @param {Object} props - Component props
 * @param {Object} props.issue - Issue object with name, severity, time, frequency
 * @param {function} [props.onSeek] - Callback to seek to issue time
 * @param {function} [props.onSolo] - Callback to solo issue frequency
 * @param {function} props.formatTime - Time formatting function
 * @param {function} props.formatFreq - Frequency formatting function
 * @returns {JSX.Element} Issue list item
 * @private
 */
